...
<?php require_once('./edit_course.php');?>
<?php require_once('./delete_course.php');?>
		...
		<nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
		  <div class="container-fluid">
			 <div class="navbar-wrapper">
				<a class="navbar-brand" href="javascript:;"><h2>Course</h2></a>
			 </div>
				  ...
				  <div class="card">
					 ...
					 <div class="card-body">
						<div class="table-responsive">
							...
							<button type="submit" class="btn btn-info pull-right" data-toggle="modal" data-target="#exampleModalCenter" name="add_btn"><i class="fa fa-plus" aria-hidden="true"></i>  Add Course</button>
						  ...
						  <div class="modal-dialog modal-dialog-centered" role="document">
							 <div class="modal-content">
								<div class="modal-header">
								  <h5 class="modal-title" id="exampleModalLongTitle">Course Form</h5>
								...
								<div class="modal-body">
								  ...
								  <div class="form-group">
									 <label>Course</label>
									 <input class="form-control <?php echo $invalid_course; ?>" type="text" name="course" required="" onkeyup="this.value = this.value.toUpperCase();">
									 <!-- For CSS styles only -->
								  ...
								  <div class="form-group">
									 <label>Code</label>
									 <input class="form-control <?php echo $invalid_code; ?>" type="text" name="code" required="" onkeyup="this.value = this.value.toUpperCase();">
									 <?php if (!$invalid_credentials): ?>
											 <div class="invalid-feedback">
												  Please enter a code.
											 </div>
		  ...
		  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
			...
			if(isset($_GET["edit"]))
			 ...
			 <div class="modal-body">
				  ...
				  <div class="form-group">
					 <label>Course</label>
					 <input type="text" name="course" id="course" class="form-control" autocomplete="off" onkeyup="this.value = this.value.toUpperCase();">
				  </div>


					<div class="form-group">
					 <label>Code</label>
					 <input type="text" name="code" id="code" class="form-control" autocomplete="off" onkeyup="this.value = this.value.toUpperCase();">
				  </div>
