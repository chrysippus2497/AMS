...
?>
<?php require_once('./add_section.php');?>
<?php require_once('./edit_section.php');?>
<?php require_once('./delete_section.php');?>

<?php require_once('./header.php')?>
  <?php 	
  			$success_msg ="";
  			$error_msg = "";
  			global  $edit_success_msg, $edit_error_msg;
			if(isset($_GET["registered"]))
				  {
					 if($_GET["registered"] == "true")
					 {
						$success_msg = '<div class="alert alert-success" style="animation: fadeOut 2s forwards;
    animation-delay: 5s;">Successfully Added.</div>';
					 }
					 elseif ($_GET["registered"] == "false") {
						 $error_msg =  '<div class="alert alert-success" style="animation: fadeOut 2s forwards;
    animation-delay: 5s;">There was an error adding the student.</div>';
					  } 
				  }
		?>
		...
		<nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
		  <div class="container-fluid">
			 <div class="navbar-wrapper">
				<a class="navbar-brand" href="javascript:;"><h2>Section</h2></a>
			 </div>
				...
				<div class="col-md-12">
				  ...
				  <div class="card">
					 <div class="card-header card-header-info">
						<h4 class="card-title ">Section Lists</h4>
					 </div>
					 <div class="card-body">
						<div class="table-responsive">
							...
							<button type="submit" class="btn btn-info pull-right" data-toggle="modal" data-target="#exampleModalCenter" name="add_btn"><i class="fa fa-plus" aria-hidden="true"></i>  Add Section</button>
						  ...
						  <div class="modal-dialog modal-dialog-centered" role="document">
							 <div class="modal-content">
								<div class="modal-header">
								  <h5 class="modal-title" id="exampleModalLongTitle">Section Form</h5>
								...
								<div class="modal-body">
								  <input type="text" name="added_by" value="<?php echo $_SESSION['username'];?>" hidden>
								  <div class="form-group">
									 <label>Section</label>
									 <input class="form-control <?php echo $invalid_secition; ?>" type="text" name="section" required="" onkeyup="this.value = this.value.toUpperCase();">
									 <!-- For CSS styles only -->
				                        ...
				                        <?php if ($invalid_credentials): ?>
				                        <p class="text-danger">
				                            <small>Section already exists.</small>
				                        </p>
				                        <?php endif; ?>
								...
								<div class="modal-footer">
								  ...
								  <button type="submit" class="btn btn-info" name="add_btn">proceed</button>
								</div>
								</form>
							 </div>
						  </div>
			...
			if(isset($_GET["edit"]))
				  {
					 ...
					 {
						$edit_success_msg  = '<div class="alert alert-success" style="animation: fadeOut 2s forwards;
    animation-delay: 5s;">Successfully Updated.</div>';
					 }
					 elseif ($_GET["edit"] == "error") {
						 $edit_error_msg = '<div class="alert alert-success" style="animation: fadeOut 2s forwards;
    animation-delay: 5s;">There was an error updating the data.</div>';
					  } 
				  }
			 ?>
			 ...
			 <div class="modal-body">
				  ...
				  <div class="form-group">
					 <label>Section</label>
					 <input type="text" name="section" id="section" class="form-control" autocomplete="off" onkeyup="this.value = this.value.toUpperCase();">
				  </div>
	 ...
	 <div class="modal-content">
		<div class="modal-header">
		  ...
		  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
			 ...
			 <p >Do you really want to delete the records of selected course? <br>This process cannot be undone.</p>
			 </center>
			 </div>
			 <div class="modal-footer">
